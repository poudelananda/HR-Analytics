...
```
![alt text](https://github.com/poudelananda/HR-Analytics/blob/main/unnamed-chunk-4-1.png)<!-- -->
...
\#Building Models \#\#\#\# Creating a logistic regression model by
partitioning.
